...
export class News extends Component {
  ...
  async updateData() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=f004d007091b403f993df1bf4dfec107&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    this.setState({
      load: true
    })
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=f004d007091b403f993df1bf4dfec107&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    this.setState({
      load: true
    })
    let data = await fetch(url);
